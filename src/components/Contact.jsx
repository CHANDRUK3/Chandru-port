...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const contactEmail = import.meta.env.VITE_CONTACT_EMAIL || 'chandruk.23cse@kongu.edu';
    ...
    if (missingConfig) {
      setStatus({
        submitting: false,
        submitted: false,
        error: `Email service is not configured. Please contact me directly at ${contactEmail}.`
      });
      return;
    }
    ...
    try {
      ...
      console.error('Email sending skipped or failed.', error);
      setStatus({
        submitting: false,
        submitted: false,
        error: `Could not send message right now. Please contact me directly at ${contactEmail}.`
      });
    }
  };
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:chandruk.23cse@kongu.edu" className="text-muted hover:text-light transition-colors">
                    chandruk.23cse@kongu.edu
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919345624126" className="text-muted hover:text-light transition-colors">
                    +91 9345624126
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/CHANDRUK3" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://linkedin.com/in/chandru-k-67b2a8329/" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
